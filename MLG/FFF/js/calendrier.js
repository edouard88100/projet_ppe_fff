// <!-- <![CDATA[
// Calendrier afficher dans modifier joueur et ajouter joueur
...
function ds_sh(t) {
	...
	var Chaine = document.forms[0].datenaiss.value; // On recupere la date du champ valeur
    ds_c_month = Chaine.substring(5,7); // On recupere le mois
    ds_c_year =  Chaine.substring(0,4); // On recupere l'annee
	// Draw the calendar
